...
module.exports = {
  ...
  run: 'bin/Code.exe',
  node_modules_parent: 'bin/resources/app'
};
...
function renameSudir(from, to) {
  ...
  if (fs.existsSync(fullTo)) {
    console.log(process.env.npm_lifecycle_event + ' already renamed to ' + fullTo);
  }
  else {
    console.log(process.env.npm_lifecycle_event + ' rename ' + fullFrom);
    fs.renameSync(
